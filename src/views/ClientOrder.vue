...
<template>
  <header-purchase header-title="Заказ клиентов"/>
  ...
  <div class="create-purchase-sidebar">
    <Sidebar
        ...
        :dismissable="false"
    >
      <view-client-order v-if="createOpenModal" @close-sidebar="closeFnVl" :productId="selectedProductId"
                           :openModalClose="openInfoModal"/>
      <CreateClientOrder v-else @close-sidebar="closeFnVl" @close-dialog="closeFn"/>
    </Sidebar>
  </div>
