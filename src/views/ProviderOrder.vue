...
import ViewProviderOrder from "@/components/providerOrder/ViewProviderOrder.vue";
import CreateProviderOrder from "@/components/providerOrder/CreateProviderOrder.vue";
...
<template>
  ...
  <div class="create-purchase-sidebar">
    ...
    >
      ...
      <view-provider-order :product-id="dataInfo.id" v-if="createOpenModal" @close-sidebar="closeFnVl" :data="dataInfo" :openModalClose="openInfoModal"/>
      <CreateProviderOrder v-else @close-sidebar="visibleRight = false" @close-dialog="closeFn"/>
    </Sidebar>
  </div>
