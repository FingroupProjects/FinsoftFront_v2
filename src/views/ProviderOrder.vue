...
<template>
  <header-purchase header-title="Заявка товаров"/>
  ...
  <div class="create-purchase-sidebar">
    <Sidebar
        ...
        :dismissable="false"
    >
      <view-provider-order v-if="createOpenModal" @close-sidebar="closeFnVl" :productId="selectedProductId"
                     :openModalClose="openInfoModal"/>
      <CreateProviderOrder v-else @close-sidebar="closeFnVl" @close-dialog="closeFn"/>
    </Sidebar>
  </div>
