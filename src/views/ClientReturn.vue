...
<template>
  <header-purchase header-title="Возврат от клиента"/>
  ...
  <div class="create-purchase-sidebar">
    ...
    >
      ...
      <view-client-return :product-id="dataInfo.id" v-if="createOpenModal" @close-sidebar="closeFnVl" :data="dataInfo"
                            :openModalClose="openInfoModal"/>
      <CreateClientReturn v-else @close-sidebar="visibleRight = false" @close-dialog="closeFn"/>
    </Sidebar>
  </div>
