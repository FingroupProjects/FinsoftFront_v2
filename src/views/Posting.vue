...
<template>
  ...
  <div class="create-purchase-sidebar">
    ...
    >
      ...
      <view-posting :product-id="dataInfo.id" v-if="createOpenModal" @close-sidebar="closeFnVl" :data="dataInfo" :openModalClose="openInfoModal"/>
      <CreatePosting v-else @close-sidebar="visibleRight = false" @close-dialog="closeFn"/>
    </Sidebar>
  </div>
