...
<template>
  <header-purchase header-title="Возврат товаров"/>
  <Loader v-if="loader"/>
  <div v-else>
  ...
  <div class="create-purchase-sidebar">
    ...
    >
      ...
      <view-provider-return :product-id="dataInfo.id" v-if="createOpenModal" @close-sidebar="closeFnVl" :data="dataInfo" :openModalClose="openInfoModal"/>
      <CreateProviderReturn v-else @close-sidebar="visibleRight = false" @close-dialog="closeFn"/>
    </Sidebar>
  </div>
