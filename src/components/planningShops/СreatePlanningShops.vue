...
const getStorages = async () =>{
  ...
  console.log('gg', getStorageList.value)
}
...
async function saveFn() {
  console.log('org', storages.value)
  try {
    const res = await useAxios(`/plan/storages`, {
      method: "POST",
      data: {
...
<template>
  <div class="create-purchases">
    <div class="header">
      <div>
        <div class="header-title">Создание план магазинов</div>
    ...
    <div>
      <table class="w-full mt-6">
        ...
        <tbody>
        <tr class="text-center" v-for="{ id: storageId, name: storageName } in getStorageList" :key="storageId">
