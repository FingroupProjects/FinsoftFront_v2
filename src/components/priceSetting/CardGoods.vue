...
<template>
  <div class="rounded-[10px] bg-[#fff] px-4 py-4 h-[80vh] w-[17%] overflow-y-scroll div_big" ref="scrollTop">
    ...
    <div v-for="(item,index) in props.priceList" :key="index"
         class="content mt-[19px] flex gap-5 items-center overflow-y-scroll">
