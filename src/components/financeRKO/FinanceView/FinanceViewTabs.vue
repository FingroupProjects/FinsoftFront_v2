...
async function saveFn() {
  if (financeDate.value.operationType?.id === 11) urlsView.value = '/cash-store/withdrawal/'
  if (financeDate.value.operationType?.id === 12) urlsView.value = '/cash-store/another-cash-register/'
  if (financeDate.value.operationType?.id === 13) urlsView.value = '/cash-store/investment/'
  if (financeDate.value.operationType?.id === 14) urlsView.value = '/cash-store/credit-receive/'
  if (financeDate.value.operationType?.id === 15) urlsView.value = '/cash-store/provider-refund/'
  if (financeDate.value.operationType?.id === 16) urlsView.value = '/cash-store/other-expenses/'
  if (financeDate.value.operationType?.id === 17) urlsView.value = '/cash-store/other-incomes/'
  openInfoModal.value = false
  changeValue.value = false
  try {
    const res = await useAxios(`${urlsView.value}${props.operationTypeId}`, {
      ...
      data: {
        ...
        recipient: financeDate.value.getUser,
