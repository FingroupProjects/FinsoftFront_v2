...
import PostingTable from "@/components/posting/PostingTable.vue";
...
<template>
  ...
  <div>
    <div class="edit-purchase">
      ...
      <div class="header">
        <div class="flex gap-[16px] pt-2">
          <div>
            <div class="header-title">Оприходование</div>
    ...
    <posting-table :info-goods="props.data" @post-goods="getProducts" @editModal="changeModal"/>
